...
angular.module('ringnetworkApp.controllers').controller('airDropReceive', function ($scope, $rootScope, go, profileService, gettextCatalog, addressService, $timeout) {
	var self = this;
						...
						addressService.getAddress(profileService.focusedClient.credentials.walletId, false, function (err, addr) {
							if (err) {
								...
								if(tempArr1){
									...
									var objectLength = require('rng-core/base/object_length');
