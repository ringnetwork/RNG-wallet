...
OutputBaseFilename={#MyAppPackageName}-win64-beta2
; SourceDir=../../builds
OutputDir=../../builds
Compression=lzma
...
[Files]
; Source: "..\builds\ringnetwork-test\win64\ringnetwork.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\builds\{#MyAppPackageName}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
