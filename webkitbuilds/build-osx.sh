...
echo "Copying ..."
mkdir -p "${STAGING_DIR}"
cp -af "${PATH_NAME}${APP_NAME}.app" "${STAGING_DIR}/${APP_NAME}-beta2.app"
...
echo '
   tell application "Finder"
     tell disk "'${VOL_NAME}'"
           ...
           set position of item "'${APP_NAME}'-beta2.app" of container window to {160, 195}
